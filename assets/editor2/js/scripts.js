...
function getBase() {
    ...
    $.ajax({
        type: "GET",
        url: "/user/skin-utilities/skinnr/skinlib/" + $('#tid').val(),
...
function makeImg() {
    $.ajax({
        ...
        url: "/user/skin-utilities/skinnr/edit",
        success: function (data) {
            base64png = data;
        }
    });
...
$(".save").click(function () {
    ...
    setTimeout(function () {
        skin.src = 'data:image/png;base64,' + base64png; // update skin image used in 3D preview
        $(".outImg").attr("src", 'data:image/png;base64,' + base64png); // show skin file
        $(".imgPrev").attr("href", 'data:image/png;base64,' + base64png); // link to skin file (on click)
        ...
        $(".makeTxt").html("生成"); // revert button to original text
    }, 2000);
...
var MSP = (function (global, undefined) {
    ...
    var t = document.createTextNode("隐藏");
